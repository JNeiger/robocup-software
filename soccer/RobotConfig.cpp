...
RobotConfig::RobotConfig(Configuration* config, QString prefix)
    : translation(config, QString("%1/translation").arg(prefix)),
      ...
      accelerationFeedForward(new ConfigDouble(
          config, QString("%1/translation/accelFF").arg(prefix))),
      velocityFeedForward(new ConfigDouble(
          config, QString("%1/translation/velFF").arg(prefix))),
