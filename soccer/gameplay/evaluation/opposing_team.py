...
def eval_num_on_offense():
	...
	ball_to_goal_dist = (ball_pos - robocup.Point(0, constants.Field.Length)).mag()
	max_bot_to_goal_dist = (robocup.Point(constants.Field.Width / 2, constants.Field.Length)).mag()
	...
	for bot in main.their_robots():
		if bot.visible:
			...
			bot_to_goal_dist = (bot.pos - robocup.Point(0, constants.Field.Length)).mag()
